...
alter table "brazilsforestcode_fcnosfa"
...
from (select s.id,
      ...
      from "brazilsforestcode_fcnosfa" s,
           "regions" b
      where st_intersects(s.geom, b.geom)
        and st_within(s.geom, b.geom)) s_intersets
where "brazilsforestcode_fcnosfa".id = s_intersets.id
  and "brazilsforestcode_fcnosfa"."region_id" is null;
...
create index "brazilsforestcode_fcnosfa_region_id_idx" on "brazilsforestcode_fcnosfa" ("region_id");
