...
class Extractor(object):
    def __init__(self, statement, raster, output, basename=None, format='GTiff', nodata=None,
                 datatype=gdal.GDT_Float32,
                 bands=1, server="localhost", dbname="geospatialservice", user="geospatialservice", password="geospatialservice"):
        assert statement
        assert raster
        assert output
...
if __name__ == '__main__':
    ...
    parser.add_argument("-d", "--dbname", type=str, default="geospatialservice", help="Database name. Default 'geospatialservice'.")
